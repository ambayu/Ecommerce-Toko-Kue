...
">
    ...
    <form style="background-color: #ffff;border: 1px solid #e3e3e3; top: 21px; " class="well form-horizontal" action="proses_input.php" method="post"  id="contact_form">
<fieldset>
...
<div class="form-group">
  ...
  <input name="phone" placeholder="(628)555-1212" class="form-control" type="text">
    </div>
  </div>
</div>
